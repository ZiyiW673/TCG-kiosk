...
if ( ! class_exists( 'TCG_Kiosk_Database' ) ) {
    class TCG_Kiosk_Database {
        ...
        protected function derive_set_name( $filename ) {
            $normalized = str_replace( array( '-', '_' ), ' ', $filename );
            return ucwords( $normalized );
        }

        /**
         * Convert a directory slug into a human friendly label.
         *
        ...
        protected function humanize_label( $slug ) {
            $slug = preg_replace( '/-tcg-data-main$/', '', $slug );
        ...
        /**
         * Determine last modification timestamp for the database.
         *
         * @return int
         */
